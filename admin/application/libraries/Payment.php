...
class CI_Payment {
	...
	var $notifyUrl;
	var	$currency   = "USD";	// 
	var	$paypal_email  = "info@plantandagri.ie";		//	
...
function paypalForm($paymentAmount,$mTable,$paymentDescription=NULL,$directPayment=FALSE,$postUrl='https://www.paypal.com/cgi-bin/webscr') {
        global $lang, $setts;
