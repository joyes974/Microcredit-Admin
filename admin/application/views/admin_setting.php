...
<table cellpadding ="0" cellspacing="0" border="0" width="100%">
        ...
        <tr height="110">
                <td align="center" valign="top">
                        <form method="post" action="<?=site_url()?>setting/admin_setting">
                        <table cellpadding ="0" cellspacing="5" border="0" width="98%" style = "border:#efefef 1px solid">
                                ...
                                <tr>
                                        ...
                                        <td>
                                                <input type="text" name="admin_username" value="<?=$admin[username]?>" size="35">
                                        </td>
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td>
                                                <input type="text" name="admin_email" value="<?=$admin[email]?>" size="35">
                                        </td>
                                </tr>
                                <tr>
                                        <td>
