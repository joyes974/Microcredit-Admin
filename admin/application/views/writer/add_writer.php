...
<form action="" method="post">
  ...
  <tr>
		  <td colspan='2' align='center'><h2><?=($seal_id=='')?"Add":"Edit"?> Employee</h2></td>
   </tr>
   <tr>
	...
	<tr>
		<td width="25%">
			<b>Employee Name: <span style='color:red'>*</span></b>
		</td>
		<td>
			<input type="text" name="fullname" size="50" value="<?=$_POST['fullname']?>"> 	
		</td>
	</tr>
	<tr>
		<td width="25%">
		...
		<td>
			<input type="text" name="fathersname" size="50" value="<?=$_POST['fathersname']?>"> 	
		</td>
	</tr>
	<tr>
		<td width="25%">
		...
		<td>
			<input type="text" name=" motthersname" size="50" value="<?=$_POST[' motthersname']?>"> 	
		</td>
	</tr>
	<tr>
		<td width="25%">
			<b>Present Address: <span style='color:red'>*</span></b>
		</td>
		<td>
			<input type="text" name="pres_address" size="50" value="<?=$_POST['pres_address']?>"> 	
		</td>
	</tr>
	<tr>
		<td width="25%">
			<b>Parmanent Address: <span style='color:red'>*</span></b>
		</td>
		<td>
			<input type="text" name="pst_address" size="50" value="<?=$_POST['pst_address']?>"> 	
		</td>
	</tr>
	<tr>
		<td width="25%">
	...
	<tr>
		...
		<td>
			<input type="text" name="salary" size="40" id='city' value="<?=$_POST['salary']?>">
		</td>
	</tr>
	...
	<tr>
		<td colspan='2' align='center'>
			<input type='submit' name='submit' value="<?=($seal_id=='')?"Add":"Edit"?> Employee">
		</td>
	</tr>
  </table>
</form>
