	...
	<tr>
		<td colspan="7">
			...
			<table>
				...
				<tr><td>Employee ID  : </td><td><input type='text' name='id' value="<?=$_REQUEST['id']?>" size='60'></td></tr>
				<tr><td>Name  : </td><td><input type='text' name='name'  value="<?=$_REQUEST['fullname']?>" size='60'></td></tr>
